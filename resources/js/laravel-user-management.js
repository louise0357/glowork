...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      order: [[2, 'desc']],
      dom:
        '<"card-header d-block d-md-flex rounded-0 flex-wrap pb-md-0 py-0"' +
        '<"me-5 ms-n2 mb-n5 mb-md-0"f>' +
        '<"d-flex justify-content-center justify-content-md-end align-items-baseline"<"dt-action-buttons d-flex align-items-center justify-content-sm-center gap-4"lB>>' +
        '>t' +
        '<"row mx-1"' +
