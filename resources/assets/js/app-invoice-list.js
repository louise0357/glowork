        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="' +
              baseUrl +
              'pages/profile-user" class="text-truncate text-heading fw-medium"><p class="mb-0">' +
              $name +
              '</p></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' +
              baseUrl +
              'app/invoice/preview" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light" data-bs-placement="top" title="Preview Invoice"><i class="ri-eye-line ri-22px"></i></a>' +
              '<div class="dropdown">' +
