  ...
  <div class="col-12 col-lg-8 pt-lg-0">
    <div class="tab-content p-0">
      ...
      <div class="tab-pane fade show active" id="shipping_delivery" role="tabpanel">
        <div class="card mb-6">
          <div class="card-header d-flex justify-content-between align-items-center gap-4 gap-sm-0">
            <div class="card-title m-0">
              <h5 class="mb-0">Shipping zones</h5>
              <p class="card-subtitle mt-0 mb-0">Choose where you ship and how much you charge for shipping at check out.</p>
            </div>
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <a href="javascript:void(0);" class="text-secondary"><i class='ri-pencil-line ri-22px me-2'></i></a>
                <a href="javascript:void(0);" class="text-secondary"><i class='ri-delete-bin-7-line ri-22px me-2'></i></a>
              </div>
            </div>
                    ...
                    <tr class="border-transparent">
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-3">
                          <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ri-more-2-line ri-22px"></i></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);"><i class="ri-pencil-line me-2"></i> Edit</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i class="ri-delete-bin-7-line me-2"></i> Delete</a>
                          </div>
            ...
            <button class="btn btn-outline-primary mb-6">Add rate</button>
