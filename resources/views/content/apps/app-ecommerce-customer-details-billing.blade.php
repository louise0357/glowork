  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2">
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/overview')}}"><i class="ri-group-line me-1_5"></i>Overview</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/security')}}"><i class="ri-lock-2-line me-1_5"></i>Security</a></li>
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="ri-map-pin-line me-1_5"></i>Address & Billing</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/ecommerce/customer/details/notifications')}}"><i class="ri-notification-4-line me-1_5"></i>Notifications</a></li>
      </ul>
    </div>
    <!--/ Customer Pills -->
            ...
            <div id="ecommerceBillingPaymentMaster" class="accordion-collapse collapse" data-bs-parent="#ecommerceBillingAccordionPayment">
              <div class="accordion-body d-flex align-items-baseline flex-wrap flex-xl-nowrap flex-sm-nowrap flex-md-wrap ms-6 ps-4 table-responsive">
                ...
                <table class="table table-sm table-borderless text-nowrap">
                  ...
                  <tr>
                    <td>CVC check</td>
                    <td class="h6">Passed <span class="badge bg-label-success rounded-circle p-0"><i class='ri-check-line'></i></span></td>
                  </tr>
                </table>
              </div>
            </div>
