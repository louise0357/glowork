        ...
        <div class="card mb-6">
          <div class="card-header">
            <div class="card-title m-0">
              ...
              <p class="card-subtitle mt-0 mb-0">Payment methods that are available with one of Vuexy's approved payment providers.</p>
            </div>
          </div>
          <div class="card-body">
            <h6 class="mb-5">Default</h6>
            <div class="bg-lightest p-3 rounded-3 mb-5">
