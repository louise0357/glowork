    ...
    <div class="card h-100">
      <div class="card-body">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-6">
          ...
          <div class="d-flex flex-column align-items-center">
            <span class="p-4 border-1 border-primary rounded-circle border-dashed mb-0 w-px-75 h-px-75"><img src="{{asset('assets/svg/icons/user-info.svg')}}" alt="Rocket"></span>
            <p class="my-2 w-75">For every new signup you get</p>
            <h6 class="text-primary mb-0">10%</h6>
          </div>
          <div class="d-flex flex-column align-items-center">
            <span class="p-4 border-1 border-primary rounded-circle border-dashed mb-0 w-px-75 h-px-75"><img src="{{asset('assets/svg/icons/paper.svg')}}" alt="Rocket"></span>
        ...
        <form class="referral-form" onsubmit="return false">
          <div class="mb-6 mt-1">
            ...
            <div class="d-flex g-2">
              <div class="w-100">
                <div class="me-3">
                  <input type="text" id="referralEmail" name="referralEmail" class="form-control form-control-sm" placeholder="Enter friend’s email & invite">
                </div>
              </div>
              <div>
                <button type="submit" class="btn btn-primary waves-effect waves-light"><i class="ri-check-line ri-16px me-1_5"></i>Submit</button>
              </div>
            </div>
          </div>
          <div class="pt-4">
