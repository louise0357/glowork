  ...
  <div class="row g-0">
    ...
    <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
      <div class="chat-sidebar-left-user sidebar-header d-flex flex-column justify-content-center align-items-center flex-wrap px-5 pt-12">
        ...
        <i class="ri-close-line ri-20px cursor-pointer close-sidebar" data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-left"></i>
      </div>
      <div class="sidebar-body px-5 pb-5">
        ...
        <div class="my-6">
          ...
          <ul class="list-unstyled d-grid gap-4 ms-2 pt-2">
        ...
        <div class="d-flex mt-6">
          <button class="btn btn-primary w-100" data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-left">Logout<i class='ri-logout-box-r-line ri-16px ms-1_5'></i></button>
        </div>
      </div>
    </div>
    <!-- /Sidebar Left-->
        ...
        <div class="chat-history-header border-bottom">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
              <i class="ri-phone-line ri-20px cursor-pointer d-sm-inline-flex d-none me-1 btn  btn-sm btn-text-secondary text-body btn-icon rounded-pill"></i>
              <i class="ri-video-add-line ri-20px cursor-pointer d-sm-inline-flex d-none me-1 btn  btn-sm btn-text-secondary text-body btn-icon rounded-pill"></i>
              <i class="ri-search-line ri-20px cursor-pointer d-sm-inline-flex d-none me-1 btn  btn-sm btn-text-secondary text-body btn-icon rounded-pill"></i>
              <div class="dropdown">
                <button class="btn  btn-sm btn-icon btn-text-secondary text-body rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown" aria-expanded="true" id="chat-header-actions"><i class="ri-more-2-line ri-20px"></i></button>
        ...
        <div class="chat-history-footer">
          <form class="form-send-message d-flex justify-content-between align-items-center ">
            ...
            <div class="message-actions d-flex align-items-center">
              <i class="btn btn-sm btn-text-secondary btn-icon rounded-pill speech-to-text ri-mic-line ri-20px cursor-pointer text-heading"></i>
    ...
    <div class="col app-chat-sidebar-right app-sidebar overflow-hidden" id="app-chat-sidebar-right">
      ...
      <div class="sidebar-body px-6">
        ...
        <div class="d-flex mt-6">
          <button class="btn btn-danger w-100" data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-right">Delete Contact<i class='ri-delete-bin-7-line ri-16px ms-1_5'></i></button>
        </div>
      </div>
    </div>
    <!-- /Sidebar Right -->
