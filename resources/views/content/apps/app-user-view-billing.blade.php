  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/account')}}"><i class="ri-group-line me-1_5"></i>Account</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/security')}}"><i class="ri-lock-2-line me-1_5"></i>Security</a></li>
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="ri-bookmark-line me-1_5"></i>Billing & Plans</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/notifications')}}"><i class="ri-notification-4-line me-1_5"></i>Notifications</a></li>
        <li class="nav-item"><a class="nav-link" href="{{url('app/user/view/connections')}}"><i class="ri-link-m me-1_5"></i>Connections</a></li>
      </ul>
    </div>
    <!--/ User Tabs -->
          ...
          <div class="col-xl-6 order-0 order-xl-0">
            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
              <h5 class="alert-heading mb-1 d-flex align-items-center">
                <span class="alert-icon rounded"><i class="ri-alert-line ri-22px"></i></span>
    ...
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        <div class="added-cards">
          <div class="cardMaster border p-5 rounded mb-4">
          ...
          <div class="cardMaster border p-5 rounded">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
