...
<div class="app-email card">
  <div class="border-0">
    <div class="row g-0">
          ...
          <ul class="email-filter-folders list-unstyled">
            <li class="active d-flex justify-content-between align-items-center mb-1" data-target="inbox">
              <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                <i class="ri-mail-line ri-20px me-1"></i>
            ...
            <li class="d-flex justify-content-between mb-1" data-target="starred">
              <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                <i class="ri-star-line ri-20px me-1"></i>
            ...
            <li class="d-flex justify-content-between align-items-center mb-1" data-target="spam">
              <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                <i class="ri-spam-2-line ri-20px me-1"></i>
            ...
            <li class="d-flex align-items-center mb-1" data-target="trash">
              <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                <i class="ri-delete-bin-7-line ri-20px me-1"></i>
            ...
            <div class="d-flex justify-content-between align-items-center ps-1">
              <div class="d-flex align-items-center">
                ...
                <div class="dropdown me-1">
                  <button class="btn btn-icon btn-text-secondary rounded-pill p-0" type="button" id="dropdownMenuFolderTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="list-unstyled m-0">
              <li class="email-list-item email-marked-read" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <span class="ms-sm-2 me-3"><i class="email-list-item-bookmark ri-star-line ri-22px d-sm-inline-block d-none cursor-pointer"></i></span>
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-label ri-circle-fill ri-10px text-danger d-none d-md-inline-block me-2" data-label="private"></span>
              ...
              <li class="email-list-item email-marked-read" data-sent="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <span class="ms-sm-2 me-3"><i class="email-list-item-bookmark ri-star-line ri-22px d-sm-inline-block d-none cursor-pointer ms-1"></i></span>
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-label ri-circle-fill ri-10px text-primary d-none d-md-inline-block me-2" data-label="important"></span>
                    <span class="email-list-item-label ri-circle-fill ri-10px text-danger d-none d-md-inline-block me-2" data-label="private"></span>
              ...
              <li class="email-list-item email-marked-read" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    ...
                    <span class="email-list-item-label ri-circle-fill ri-10px text-primary d-none d-md-inline-block me-2" data-label="company"></span>
              ...
              <li class="email-list-item email-marked-read" data-spam="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-label ri-circle-fill ri-10px text-danger d-none d-md-inline-block me-2" data-label="company"></span>
                    <small class="email-list-item-time text-muted">Yesterday</small>
                    <ul class="list-inline email-list-item-actions">
                      <li class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill"> <i class='ri-delete-bin-7-line ri-22px'></i></li>
                      <li class="list-inline-item email-unread btn btn-icon btn-text-secondary rounded-pill"> <i class='ri-mail-line ri-22px'></i> </li>
              ...
              <li class="email-list-item email-marked-read" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-label ri-circle-fill ri-10px text-warning d-none d-md-inline-block me-2" data-label="company"></span>
              ...
              <li class="email-list-item email-marked-read" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                <div class="d-flex align-items-center">
                  ...
                  <div class="email-list-item-meta ms-auto d-flex align-items-center">
                    <span class="email-list-item-label ri-circle-fill ri-10px text-success d-none d-md-inline-block me-2" data-label="company"></span>
      ...
      <!-- Email View -->
      <div class="col app-email-view flex-grow-0 bg-lightest" id="app-email-view">
        <div class="card-body app-email-view-header p-5 pt-md-4 py-2">
          <!-- Email View : Title  bar-->
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center overflow-hidden">
              <span class="ms-sm-2 me-3"><i class="ri-arrow-left-s-line ri-22px cursor-pointer" data-bs-toggle="sidebar" data-target="#app-email-view"></i></span>
        ...
        <div class="app-email-view-content py-4">
          ...
          <div class="email-reply card mt-4 mx-sm-6 mx-3 mb-4">
            ...
            <div class="card-body pt-0 ps-3">
              ...
              <div class="d-flex justify-content-end align-items-center mt-1_5">
                <div class="cursor-pointer btn btn-text-secondary me-4">
                  <i class="ri-attachment-2 ri-16px me-1_5"></i>
                  <span class="align-middle">Attachments</span>
                </div>
                <button class="btn btn-primary">
                  <span class="align-middle">Send</span>
                  <i class="ri-send-plane-line ri-16px ms-1_5"></i>
                </button>
              </div>
            </div>
          </div>
  ...
  <div class="app-email-compose modal" id="emailComposeSidebar" tabindex="-1" aria-labelledby="emailComposeSidebar" aria-hidden="true">
    <div class="modal-dialog m-0 me-md-6 mb-6 modal-lg">
      <div class="modal-content p-0">
        <div class="modal-header pb-5 justify-content-between">
