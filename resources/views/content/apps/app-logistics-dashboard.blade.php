    ...
    <div class="card h-100">
      ...
      <div class="card-body pb-2">
        ...
        <div class="vehicles-overview-progress progress rounded bg-transparent mb-2" style="height: 46px;">
          <div class="progress-bar small fw-medium text-start rounded-start bg-lightest text-heading px-1 px-lg-4" role="progressbar" style="width: 39.7%" aria-valuenow="39.7" aria-valuemin="0" aria-valuemax="100">39.7%</div>
  ...
  <div class="col-md-6 col-xxl-4 mb-6 order-1 order-xxl-3">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn p-0" type="button" id="reasonsDeliveryExceptions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ri-more-2-line ri-20px"></i>
          </button>
