        ...
        <div class="card mb-6">
          <div class="card-header">
            <div class="card-title m-0">
              ...
              <p class="card-subtitle mt-0 mb-0">Select what contact method customers use to check out.</p>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="alert d-flex align-items-center alert-warning mb-0 h5" role="alert">
              <span class="alert-icon rounded-2"><i class="ri-information-line ri-22px"></i></span>
              <span>
