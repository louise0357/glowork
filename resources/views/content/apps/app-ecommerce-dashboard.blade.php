      ...
      <div class="col-sm-6">
        <div class="card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="revenueID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="col-sm-6">
        <div class="card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="transactionsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
        ...
        <div class="col-md-5 border-start ps-md-0">
          ...
          <div class="card-header">
            <div class="d-flex justify-content-between">
              ...
              <div class="dropdown">
                <button class="btn text-muted p-0" type="button" id="totalProfit" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="ri-more-2-line ri-24px"></i>
                </button>
          ...
          <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
            <div class="me-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <p class="text-success mb-0"> <i class="ri-arrow-up-s-line ri-24px"></i>15.6%</p>
              </div>
            </div>
      ...
      <div class="col-sm-6">
        <div class="card">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="logisticsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
      ...
      <div class="col-sm-6">
        <div class="card h-100">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="reportsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
