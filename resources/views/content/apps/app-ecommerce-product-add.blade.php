              ...
              <div class="tab-content p-0 pe-xl-0 ps-md-4">
                ...
                <div class="tab-pane fade show active" id="restock" role="tabpanel">
                  ...
                  <div class="row mb-4 g-4">
                    <div class="col-12 col-sm-8 col-lg-12 col-xxl-8">
                      <div>
                        <input type="number" class="form-control form-control-sm" id="ecommerce-product-stock" placeholder="Add to Stock" name="Add to Stock" aria-label="Add to Stock"> </div>
                    </div>
                    <div class="col-6 col-sm-4 col-lg-6 col-xxl-4">
                      <button class="btn btn-primary"><i class='ri-check-line ri-16px me-1_5'></i>Confirm</button>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div class="form-check mb-6">
                      ...
                      <label class="form-check-label" for="companyName">
                        <span class="h6">Fulfilled by Company name &nbsp;<span class="badge rounded-pill badge-warning bg-label-warning fs-tiny py-1">RECOMMENDED</span></span><br>
                ...
                <div class="tab-pane fade" id="global-delivery" role="tabpanel">
                  ...
                  <div class="form-check mb-4">
                    ...
                    <div>
                      <input type="text" class="form-control form-control-sm" placeholder="Countries" id="country-selected">
                    </div>
                  </div>
                  <!-- Local delivery -->
                ...
                <div class="tab-pane fade" id="attributes" role="tabpanel">
                  ...
                  <div>
                    ...
                    <div class="form-check mb-4">
                      ...
                      <div>
                        <input type="number" class="form-control form-control-sm" placeholder="Max. allowed Temperature" id="temp">
                      </div>
                    </div>
                    <!-- Exp Date -->
                    <div class="form-check">
                ...
                <div class="tab-pane fade" id="advanced" role="tabpanel">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      ...
                      <div>
                        <select id="product-id" class="form-select form-select-sm" data-placeholder="ISBN" data-allow-clear="true">
                    ...
                    <div class="col">
                      ...
                      <div>
                        <input type="number" id="product-id-1" class="form-control form-control-sm" placeholder="ISBN Number" />
                      </div>
                    </div>
