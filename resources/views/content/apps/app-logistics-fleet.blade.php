...
<div class="card overflow-hidden">
  ...
  <div class="d-flex app-logistics-fleet-wrapper">
    ...
    <div class="app-logistics-fleet-sidebar col h-100 rounded-0" id="app-logistics-fleet-sidebar">
      <div class="card-header border-0 pt-6 pb-0 d-flex justify-content-between">
      ...
      <div class="card-body p-0 logistics-fleet-sidebar-body">
        <!-- Menu Accordion -->
        <div class="accordion p-5 ps-0 pt-2" id="fleet" data-bs-toggle="sidebar" data-overlay data-target="#app-logistics-fleet-sidebar">
          <!-- Fleet 1 -->
              ...
              <div class="accordion-body pt-4 pb-0">
                ...
                <ul class="timeline ps-4 mt-8">
                  <li class="timeline-item ps-6 border-left-dashed">
                    ...
                    <div class="timeline-event ps-1 pb-3">
