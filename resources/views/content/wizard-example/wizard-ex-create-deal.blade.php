        ...
        <div class="row g-5">
          ...
          <div class="col-lg-12">
            <div class="form-check form-switch">
              ...
              <label for="dealLimitUser">Limit this discount to a single-use per customer?</label>
            </div>
          </div>
          <div class="col-12 d-flex justify-content-between">
            <button class="btn btn-outline-secondary btn-prev"> <i class="ri-arrow-left-line ri-16px me-sm-1 me-0"></i>
            ...
            <div class="row">
              ...
              <div class="col-12 mb-0">
                ...
                <div class="form-check form-switch">
                  ...
                  <label for="dealLimitUser">I have confirmed the deal details.</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 d-flex align-items-center justify-content-center border rounded-3 pt-3">
