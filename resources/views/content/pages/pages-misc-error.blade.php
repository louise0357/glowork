...
<div class="misc-wrapper">
  ...
  <div class="d-flex justify-content-center mt-5">
    ...
    <img src="{{asset('assets/img/illustrations/misc-mask-'.$configData['style'].'.png')}}" alt="misc-error" class="scaleX-n1-rtl misc-bg d-none d-lg-inline-block" height="172" data-app-light-img="illustrations/misc-mask-light.png" data-app-dark-img="illustrations/misc-mask-dark.png">
