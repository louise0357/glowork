  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='ri-user-3-line me-1_5'></i>Profile</a></li>
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-auto">
                    <button class="btn btn-outline-primary btn-icon"><i class="ri-user-add-line ri-22px"></i></button>
                  </div>
                </div>
              </li>
              <li class="mb-4">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-auto">
                    <button class="btn btn-primary btn-icon"><i class="ri-user-3-line ri-22px"></i></button>
                  </div>
                </div>
              </li>
              <li class="mb-4">
