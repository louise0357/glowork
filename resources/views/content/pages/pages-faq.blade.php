...
<div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative overflow-hidden rounded-3">
  ...
  <div class="input-wrapper my-6 input-group input-group-merge px-sm-5">
    ...
    <div class="d-flex justify-content-between flex-column nav-align-left mb-2 mb-md-0">
      ...
      <div class="d-none d-md-block">
        <div class="mt-5 text-center">
          <img src="{{asset('assets/img/illustrations/illustration-john.png')}}" class="img-fluid w-px-300" alt="FAQ Image">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="tab-content p-0">
        ...
        <div class="d-flex mb-4 gap-4">
          <div class="avatar avatar-md">
            <div class="avatar-initial bg-label-primary rounded">
              <i class="ri-bank-card-line ri-28px"></i>
            </div>
          </div>
          <div>
            <h5 class="mb-1">
      ...
      <div class="tab-pane fade" id="cancellation" role="tabpanel">
        <div class="d-flex mb-4 gap-4 align-items-center">
          ...
          <div>
            <h5 class="mb-1"><span class="align-middle">Cancellation & Return</span></h5>
            <span>Lorem ipsum, dolor sit amet.</span>
          </div>
        </div>
      ...
      <div class="tab-pane fade" id="orders" role="tabpanel">
        <div class="d-flex mb-4 gap-4 align-items-center">
          <div class="avatar avatar-md">
            <span class="avatar-initial bg-label-primary rounded">
              <i class="ri-inbox-archive-line ri-24px"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-1">
...
<div class="row justify-content-center gap-sm-0 gap-6">
  <div class="col-sm-6">
    <div class="py-6 rounded bg-faq-section d-flex align-items-center flex-column">
      ...
      <p class="mb-1">We are always happy to help</p>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="py-6 rounded bg-faq-section d-flex align-items-center flex-column">
      ...
      <p class="mb-1">Best way to get a quick answer</p>
    </div>
  </div>
</div>
<!-- /Contact -->
