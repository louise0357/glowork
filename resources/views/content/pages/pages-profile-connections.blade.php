  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-sm-row mb-6">
        ...
        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='ri-link-m me-1_5'></i> Connections</a></li>
      </ul>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="d-flex align-items-center justify-content-center">
          <a href="javascript:;" class="btn btn-primary d-flex align-items-center me-4"><i class="ri-user-follow-line ri-16px me-1_5"></i>Connected</a>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="d-flex align-items-center justify-content-center">
          <a href="javascript:;" class="btn btn-outline-primary d-flex align-items-center me-4"><i class="ri-user-add-line ri-16px me-1_5"></i>Connect</a>
          <a href="javascript:;" class="btn btn-outline-secondary btn-icon"><i class="ri-mail-open-line ri-22px"></i></a>
        </div>
      </div>
    </div>
