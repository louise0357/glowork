...
<div class="row">
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <div>
          ...
          <p class="text-body mb-0">Commercial networks</p>
        </div>
        <div class="dropdown">
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        <div>
          ...
          <p class="text-body  mb-0">Commercial networks & enterprises</p>
        </div>
  ...
  <div class="col-md-6 col-12 mb-6">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <div>
          <p class="mb-1 text-body">Balance</p>
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div>
          ...
          <p class="text-body mb-0">$50,863.98</p>
        </div>
        <div class="dropdown">
          <button type="button" class="btn dropdown-toggle px-0" data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-calendar-2-line"></i></button>
          <ul class="dropdown-menu dropdown-menu-end">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div>
          ...
          <p class="text-body mb-0">Spending on various categories</p>
        </div>
