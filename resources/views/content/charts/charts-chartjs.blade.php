...
<div class="row">
    ...
    <div class="card">
      <div class="card-header header-elements">
        <div>
          ...
          <p class="text-body mb-0">Commercial networks and enterprises</p>
        </div>
        <div class="card-header-elements ms-auto py-0">
          <h5 class="mb-0 me-4">$ 78,000</h5>
          <span class="badge bg-label-secondary rounded-pill">
            <i class='ri-arrow-up-line ri-14px text-success align-middle'></i>
    ...
    <div class="card">
      <div class="card-header header-elements">
        ...
        <div class="card-header-elements ms-auto py-0 dropdown">
          <button type="button" class="btn dropdown-toggle hide-arrow p-0" id="heat-chart-dd" data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-2-line"></i></button>
    ...
    <div class="card">
      <div class="card-header header-elements">
        ...
        <div class="card-header-elements ms-auto py-0">
          ...
          <span class="badge bg-label-secondary rounded-pill">
            <i class='ri-arrow-down-line ri-14px text-danger align-baseline'></i>
  ...
  <!-- Doughnut Chart -->
  <div class="col-lg-4 col-12 mb-6 mb-lg-0">
    <div class="card">
