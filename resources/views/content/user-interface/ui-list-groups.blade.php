            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex justify-content-between">
              <div class="li-wrapper d-flex justify-content-start align-items-center">
                ...
                <div class="list-content">
                  ...
                  <small class="text-body">Donec id elit non mi porta.</small>
                </div>
              </div>
              <small>3 days ago</small>
            </a>
        ...
        <div class="demo-inline-spacing mt-4">
          <div class="list-group">
            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
              <img src="{{asset('assets/img/avatars/2.png')}}" alt="User Image" class="rounded-circle avatar me-4">
              <div class="w-100">
                <div class="d-flex justify-content-between">
                  <div class="user-info">
                    <h6 class="mb-0 fw-normal">Danish sesame snaps halvah</h6>
                    <div class="d-flex align-items-center">
                      <div class="user-status me-2 d-flex align-items-center">
                        <span class="badge badge-dot bg-success me-1"></span>
                        <small class="text-body">Online</small>
                      </div>
            ...
            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
              <img src="{{asset('assets/img/avatars/8.png')}}" alt="User Image" class="rounded-circle avatar me-4">
              <div class="w-100">
                <div class="d-flex justify-content-between">
                  <div class="user-info">
                    <h6 class="mb-0 fw-normal">Cake halvah biscuit cheesecake</h6>
                    <div class="d-flex align-items-center">
                      <div class="user-status me-2 d-flex align-items-center">
                        <span class="badge badge-dot bg-warning me-1"></span>
                        <small class="text-body">Away</small>
                      </div>
            ...
            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
              <img src="{{asset('assets/img/avatars/4.png')}}" alt="User Image" class="rounded-circle avatar me-4">
              <div class="w-100">
                <div class="d-flex justify-content-between">
                  <div class="user-info">
                    <h6 class="mb-0 fw-normal">Tart cheesecake jujubes caramels</h6>
                    <div class="d-flex align-items-center">
                      <div class="user-status me-2 d-flex align-items-center">
                        <span class="badge badge-dot bg-secondary me-1"></span>
                        <small class="text-body">Offline</small>
                      </div>
            ...
            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
              <img src="{{asset('assets/img/avatars/11.png')}}" alt="User Image" class="rounded-circle avatar me-4">
              <div class="w-100">
                <div class="d-flex justify-content-between">
                  <div class="user-info">
                    <h6 class="mb-0 fw-normal">Icing sweet gummies</h6>
                    <div class="d-flex align-items-center">
                      <div class="user-status me-2 d-flex align-items-center">
                        <span class="badge badge-dot bg-danger me-1"></span>
                        <small class="text-body">In Meeting</small>
                      </div>
        ...
        <div class="demo-inline-spacing mt-4">
          <div class="list-group">
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
              <div class="avatar flex-shrink-0 bg-primary d-flex align-items-center justify-content-center rounded me-4"><i class="ri-bootstrap-line ri-24px text-white"></i></div>
              <div class="w-100">
            ...
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
              <div class="avatar flex-shrink-0 bg-success d-flex align-items-center justify-content-center rounded me-4"><i class="ri-vuejs-line ri-24px text-white"></i></div>
              <div class="w-100">
                <h6 class="mb-2">Vue.js is the Progressive JavaScript Framework</h6>
                <div class="progress bg-label-success" style="height: 5px;">
                  <div class="progress-bar bg-success" role="progressbar" style="width: 85%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </a>
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
              <div class="avatar flex-shrink-0 bg-danger d-flex align-items-center justify-content-center rounded me-4"><i class="ri-angularjs-line ri-24px text-white"></i></div>
              <div class="w-100">
                <h6 class="mb-2">Angular implements Functional Programming concepts</h6>
                <div class="progress bg-label-danger" style="height: 5px;">
                  <div class="progress-bar bg-danger" role="progressbar" style="width: 55%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </a>
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
              <div class="avatar flex-shrink-0 bg-info d-flex align-items-center justify-content-center rounded me-4"><i class="ri-reactjs-line ri-24px text-white"></i></div>
              <div class="w-100">
                <h6 class="mb-2">List group item heading</h6>
                <div class="progress bg-label-info" style="height: 5px;">
                  <div class="progress-bar bg-info" role="progressbar" style="width: 75%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </a>
            <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
              <div class="avatar flex-shrink-0 bg-warning d-flex align-items-center justify-content-center rounded me-4"><i class="ri-javascript-line ri-24px text-white"></i></div>
              <div class="w-100">
                <h6 class="mb-2">JavaScript is the programming language of the Web</h6>
                <div class="progress bg-label-warning" style="height: 5px;">
