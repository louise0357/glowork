...
<div class="row">
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="row row-bordered g-0">
        ...
        <div class="col-lg-4 p-6">
          <small class="text-light fw-medium">Label(Tonal)</small>
          <div class="demo-inline-spacing">
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="row row-bordered g-0">
        <div class="col-lg-6 p-6">
          <small class="text-light fw-medium">Extended Basic</small>
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-primary btn-fab demo">
              <span class="tf-icons ri-check-double-line ri-16px me-1"></span>Primary
            </button>
            <button type="button" class="btn btn-secondary btn-fab demo">
              <span class="tf-icons ri-notification-4-line ri-16px me-1"></span>Secondary
            </button>
          </div>
          <div class="demo-inline-spacing">
        ...
        <div class="col-lg-6 p-6">
          <small class="text-light fw-medium">Extended Label</small>
          <div class="demo-inline-spacing">
    ...
    <div class="card mb-6">
      ...
      <div class="row row-bordered g-0">
        <div class="col-lg-4 p-6">
          <small class="text-light fw-medium">Basic</small>
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-facebook"><i class="tf-icons ri-facebook-circle-fill ri-16px me-1_5"></i>Facebook</button>
            <button type="button" class="btn btn-twitter"><i class="tf-icons ri-twitter-fill ri-16px me-1_5"></i>Twitter</button>
          </div>
          <div class="demo-inline-spacing">
            <button type="button" class="btn rounded-pill btn-google-plus">
              <i class="tf-icons ri-google-fill ri-16px me-1_5"></i>Google+
            </button>
            <button type="button" class="btn rounded-pill btn-instagram">
              <i class="tf-icons ri-instagram-line ri-16px me-1_5"></i>Instagram
            </button>
          </div>
        </div>
        <div class="col-lg-4 p-6">
          <small class="text-light fw-medium">Label(Tonal)</small>
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-label-linkedin"><i class="tf-icons ri-linkedin-box-fill ri-16px me-1_5"></i>Linkedin</button>
            <button type="button" class="btn btn-label-github"><i class="tf-icons ri-github-fill ri-16px me-1_5"></i>Github</button>
          </div>
          <div class="demo-inline-spacing">
            <button type="button" class="btn rounded-pill btn-label-pinterest"> <i class="tf-icons ri-pinterest-fill ri-16px me-1_5"></i>Pinterest </button>
            <button type="button" class="btn rounded-pill btn-label-slack"> <i class="tf-icons ri-slack-line ri-16px me-1_5"></i>Slack </button>
          </div>
        </div>
        <div class="col-lg-4 p-6">
          <small class="text-light fw-medium">Outline & Text</small>
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-outline-whatsapp"> <i class="tf-icons ri-whatsapp-line ri-16px me-1_5"></i>WhatsApp</button>
            <button type="button" class="btn btn-text-reddit"><i class="tf-icons ri-reddit-fill ri-16px me-1_5"></i>Reddit</button>
          </div>
          <div class="demo-inline-spacing">
            <button type="button" class="btn rounded-pill btn-outline-youtube"> <i class="tf-icons ri-youtube-fill ri-16px me-1_5"></i>Youtube </button>
            <button type="button" class="btn rounded-pill btn-text-vimeo"> <i class="tf-icons ri-vimeo-fill ri-16px me-1_5"></i>Vimeo </button>
          </div>
        </div>
      </div>
      <hr class="m-0" />
      <div class="row row-bordered g-0">
        <div class="col-lg-4 p-6">
          ...
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-icon btn-facebook"><i class="tf-icons ri-facebook-circle-fill ri-22px"></i></button>
            <button type="button" class="btn btn-icon btn-twitter"><i class="tf-icons ri-twitter-fill ri-22px"></i></button>
            <button type="button" class="btn btn-icon rounded-pill btn-google-plus ri-22px">
              <i class="tf-icons ri-google-fill ri-22px"></i>
            </button>
            <button type="button" class="btn btn-icon rounded-pill btn-instagram ri-22px">
              <i class="tf-icons ri-instagram-line ri-22px"></i>
            </button>
          </div>
        </div>
        <div class="col-lg-4 p-6">
          <small class="text-light fw-medium">Label(Tonal) Icons</small>
          <div class="demo-inline-spacing">
            <button type="button" class="btn btn-icon btn-label-linkedin"><i class="tf-icons ri-linkedin-box-fill ri-22px"></i></button>
            <button type="button" class="btn btn-icon btn-label-github"><i class="tf-icons ri-github-fill ri-22px"></i></button>
            <button type="button" class="btn btn-icon rounded-pill btn-label-pinterest ri-22px">
              <i class="tf-icons ri-pinterest-fill ri-22px"></i>
            </button>
            <button type="button" class="btn btn-icon rounded-pill btn-label-slack ri-22px">
              <i class="tf-icons ri-slack-line ri-22px"></i>
            </button>
          </div>
        </div>
        <div class="col-lg-4 p-6">
          ...
          <div class="demo-inline-spacing">
            ...
            <button type="button" class="btn btn-icon btn-text-reddit"><i class="tf-icons ri-reddit-fill ri-22px"></i></button>
            <button type="button" class="btn btn-icon rounded-pill btn-outline-youtube ri-22px">
              <i class="tf-icons ri-youtube-fill ri-22px"></i>
            </button>
            <button type="button" class="btn btn-icon rounded-pill btn-text-vimeo ri-22px">
              <i class="tf-icons ri-vimeo-fill ri-22px"></i>
            </button>
          </div>
        </div>
      </div>
