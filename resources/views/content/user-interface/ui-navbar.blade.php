...
<div class="mb-12">
  <h6 class="mt-2 mb-4 text-muted">Open on click</h6>
  <nav class="navbar navbar-example navbar-expand-lg bg-lighter" style="z-index: 21">
    <div class="container-fluid">
      <a class="navbar-brand" href="javascript:void(0)">Navbar</a>
              ...
              <div class="row row-bordered">
                <div class="col-sm-6 col-lg p-4">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons ri-mail-line me-1"></i>Email</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons ri-question-answer-line me-1"></i>Chat</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons ri-clipboard-line me-1"></i>ToDos</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="javascript:void(0)"><i class="tf-icons ri-calendar-2-line me-1"></i>Calender</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link disabled" href="javascript:void(0)" tabindex="-1"><i class="tf-icons ri-prohibited-line me-1"></i>Disabled</a>
                    </li>
                  </ul>
                </div>
                <div class="col-sm-6 col-lg p-4">
                ...
                <div class="col-sm-6 col-lg p-4 mt-4">
                  <form onsubmit="return false">
  ...
  <h6 class="mt-6 mb-4 text-muted">Open on hover</h6>
  <nav class="navbar navbar-example navbar-expand-lg bg-lighter" style="z-index: 20">
    <div class="container-fluid">
      <a class="navbar-brand" href="javascript:void(0)">Navbar</a>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-ex-7">
        ...
        <ul class="navbar-nav ms-lg-auto">
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon ri-user-line me-1"></i>Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon ri-settings-3-line me-1"></i>Settings</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);"><i class="tf-icons navbar-icon ri-lock-2-line me-1"></i>Logout</a>
          </li>
        </ul>
      </div>
    </div>
