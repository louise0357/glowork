  ...
  <div class="card-body">
    ...
    <div class="row mt-4 gap-2 gap-sm-0">
      <div class="col-12 col-sm-6 col-md-4">
        <select class="form-select form-select-sm animation-dropdown" id="animation-dropdown">
            ...
            <div class="modal-content text-center">
              ...
              <div id="modalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="onboarding-content">
                      <h5 class="onboarding-title text-body">Example Request Information</h5>
                ...
                <a class="carousel-control-prev" href="#modalCarouselControls" role="button" data-bs-slide="prev">
                  <i class="ri-arrow-left-double-line lh-1 me-1"></i><span>Previous</span>
                </a>
                <a class="carousel-control-next" href="#modalCarouselControls" role="button" data-bs-slide="next">
                  <span>Next</span><i class="ri-arrow-right-double-line lh-1 ms-1"></i>
                </a>
              </div>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <label for="nameEx3">Your Full Name</label>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <label for="roleEx3">Your Role</label>
                        </div>
                      </div>
                    </div>
                  </form>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <label for="nameEx7">Your Full Name</label>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-floating form-floating-outline mb-4">
                          ...
                          <label for="roleEx7">Your Role</label>
                        </div>
                      </div>
                    </div>
                  </form>
