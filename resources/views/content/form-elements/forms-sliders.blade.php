  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="card-body">
        ...
        <div id="slider-handles" class="mt-4"></div>
        <small class="text-light fw-medium">Snapping between steps</small>
        <div id="slider-steps" class="my-4"></div>
      </div>
    </div>
  </div>
  <!-- /Basic -->
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="card-body pb-5 mb-5">
        <div class="mb-3" id="slider-pips"></div>
      </div>
    </div>
  </div>
  <!-- /Scale & Pips -->
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="card-body pb-12">
        ...
        <div class="noUi-primary" id="slider-primary"></div>
        <small class="text-light fw-medium">Success</small>
        <div class="noUi-success" id="slider-success"></div>
        <small class="text-light fw-medium">Danger</small>
        <div class="noUi-danger" id="slider-danger"></div>
        <small class="text-light fw-medium">Warning</small>
        <div class="noUi-warning" id="slider-warning"></div>
        <small class="text-light fw-medium">Info</small>
        <div class="noUi-info" id="slider-info"></div>
      </div>
    </div>
  </div>
  <!-- /Colors -->
