    ...
    <div class="card mb-6">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6 mb-6">
            <div class="form-floating form-floating-outline">
              <input id="TagifyBasic" class="form-control h-auto" name="TagifyBasic" value="Tag1, Tag2, Tag3" />
          ...
          <div class="col-md-6 mb-6">
            <div class="form-floating form-floating-outline">
              <input id="TagifyReadonly" class="form-control readonlyMix" readonly value='[
              {"value" : "tag1", "readonly" : true, "title" : "Non-editable Read-only tag"}, {"value" : "tag2","title" : "Editable read-only tag"},{"value" : "tag3","readonly" : true,"title" : "Another readonly tag"}]' />
          ...
          <div class="col-md-6 mb-6">
            ...
            <button type="button" class="btn btn-sm rounded-pill btn-icon btn-outline-primary mb-1"> <span class="tf-icons ri-add-line"></span> </button>
          </div>
        </div>
      </div>
    </div>
