  ...
  <div class="col-md-6 col-xxl-3 order-0 order-sm-4 order-xxl-0">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-muted p-0" type="button" id="socialAnalytics" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ri-more-2-line ri-24px"></i>
          </button>
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-muted p-0" type="button" id="webStatistics" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ri-more-2-line ri-24px"></i>
          </button>
        ...
        <div>
          <div class="d-flex align-items-center py-3">
            <span class="text-success me-2">
              <i class="ri-circle-fill ri-16px"></i>
            </span>
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          <li class="d-flex mb-4 pb-1 align-items-center">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded bg-label-primary"><i class="ri-gift-line ri-26px"></i></span>
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded bg-label-success"><i class="ri-check-line text-success ri-26px"></i></span>
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded bg-label-warning"><i class="ri-home-6-line ri-26px"></i></span>
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded bg-label-secondary"><i class="ri-time-line ri-26px"></i></span>
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="cafeApp" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
        ...
        <p>Italian Cafe</p>
        <p class="border-bottom pb-4">The refrigerated dairy aisle of your local grocery store can be a great source tasty, convenient selections for your.</p>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Jordan Stevenson</a></h6>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Richard Payne</a></h6>
              ...
              <td>
                <div class="avatar avatar-sm">
                  <div class="avatar-initial bg-label-info rounded-circle">
                    <i class="ri-arrow-down-line ri-16px"></i>
                  </div>
                </div>
              </td>
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Jennifer Summers</a></h6>
              ...
              <td>
                <div class="avatar avatar-sm">
                  <div class="avatar-initial bg-label-secondary rounded-circle">
                    <i class="ri-mail-line ri-16px"></i>
                  </div>
                </div>
              </td>
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Mr. Justin Richardson</a></h6>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Nicholas Tanner</a></h6>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Crystal Mays</a></h6>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Mary Garcia</a></h6>
            ...
            <tr class="border-transparent">
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0 text-truncate"><a href="{{url('pages/profile-user')}}" class="text-heading">Megan Roberts</a></h6>
