    ...
    <div class="card h-100">
      <div class="card-header pb-1">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="totalVisitorsDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="weeklySalesDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header pb-1">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="totalRevenueDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="AnalyticsDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header pb-1">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="salesStateDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          <h5 class="mb-0">Total Profit</h5>
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="totalProfitDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="totalVisitsDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
    ...
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          ...
          <span class="text-muted">Total number of deliveries 23.8k</span>
        </div>
        <div class="btn-group">
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-muted p-0" type="button" id="deliveryExceptions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
