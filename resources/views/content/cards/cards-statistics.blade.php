        ...
        <div class="d-flex align-items-center flex-wrap gap-2">
          <div class="avatar me-2">
            <div class="avatar-initial rounded shadow-xs">
              <i class="ri-group-line ri-24px text-primary"></i>
            </div>
          </div>
          <div class="card-info">
    ...
    <div class="card transparent-card bg-transparent shadow-none border-1">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          <div class="avatar me-2">
            <div class="avatar-initial rounded shadow-xs">
              <i class="ri-money-dollar-circle-line ri-24px text-success"></i>
            </div>
          </div>
          <div class="card-info">
    ...
    <div class="card transparent-card bg-transparent shadow-none border-1">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          <div class="avatar me-2">
            <div class="avatar-initial rounded shadow-xs">
              <i class="ri-pie-chart-2-line ri-24px text-info"></i>
            </div>
          </div>
          <div class="card-info">
    ...
    <div class="card transparent-card bg-transparent shadow-none border-1">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          <div class="avatar me-2">
            <div class="avatar-initial rounded shadow-xs">
              <i class="ri-pie-chart-2-line ri-24px text-warning"></i>
            </div>
          </div>
          <div class="card-info">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="h-100 position-relative">
            <img src="{{asset('assets/img/illustrations/illustration-1.png')}}" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="95">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-xl-3 col-lg-6 col-sm-6 mt-10">
    <div class="card">
      <div class="row">
        ...
        <div class="col-6">
          <div class="h-100 position-relative">
            <img src="{{asset('assets/img/illustrations/illustration-3.png')}}" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="84">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-xl-3 col-lg-6 col-sm-6 mt-10">
    <div class="card">
      <div class="row">
        ...
        <div class="col-6">
          <div class="h-100 position-relative">
            <img src="{{asset('assets/img/illustrations/illustration-4.png')}}" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="78">
          </div>
        </div>
      </div>
    </div>
