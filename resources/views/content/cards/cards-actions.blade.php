  ...
  <div class="card-header">
    ...
    <div class="card-action-element">
      <ul class="list-inline mb-0">
        ...
        <li class="list-inline-item">
          <a href="javascript:void(0);" class="card-expand"><i class="tf-icons ri-fullscreen-fill"></i></a>
        </li>
        <li class="list-inline-item">
          <a href="javascript:void(0);" class="card-close"><i class="tf-icons ri-close-fill"></i></a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td>Expand Card</td>
          <td class="text-center">
            <i class="tf-icons ri-fullscreen-fill"></i>
          </td>
  ...
  <div class="col-md">
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Click on <i class="tf-icons ri-fullscreen-fill"></i> icon to see expand card in action.</p>
      </div>
    </div>
  </div>
  <div class="col-md">
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        ...
        <br />
        <p class="card-text">Click on <i class="tf-icons ri-close-fill"></i> icon to see remove card in action.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md">
    <div class="card mb-6">
      <div class="card-header header-elements">
        ...
        <div class="card-header-elements ms-auto">
          <button type="button" class="btn btn-xs btn-primary"><span class="tf-icon ri-add-fill me-1"></span>Button</button>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="card-title header-elements">
          ...
          <div class="card-title-elements ms-auto">
            <button type="button" class="btn btn-icon btn-sm btn-primary">
              <span class="tf-icon ri-shopping-bag-3-line"></span>
            </button>
          </div>
        </div>
  ...
  <div class="col-md">
    <div class="card mb-6">
      <div class="card-header header-elements">
        <h5 class="mb-0 me-2">Card Header</h5>
        <div class="card-header-elements ms-auto">
          <span class="tf-icon ri-notification-2-line text-muted"></span>
