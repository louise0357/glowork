...
<div class="row gy-6 align-items-end">
  ...
  <div class="col-lg-4">
    <div class="card">
      ...
      <img src="{{asset('assets/img/illustrations/illustration-upgrade-account-2.png')}}" class="scaleX-n1-rtl position-absolute bottom-0 end-0 me-5 mb-3" height="176" alt="Upgrade Account">
    </div>
  </div>
</div>
@endsection
