  ...
  <section id="landingHero" class="section-py landing-hero position-relative">
    ...
    <div class="container">
      ...
      <div class="position-relative hero-animation-img">
        <a href="{{url('/dashboard/crm')}}" target="_blank">
  ...
  <section id="landingFeatures" class="section-py landing-features">
    <div class="container">
      <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
        <img src="{{asset('assets/img/front-pages/icons/section-tilte-icon.png')}}" alt="section title icon" class="me-2" height="19" />
        ...
        <div class="col-lg-5">
          <div class="card h-100">
            <div class="bg-primary rounded text-white card-body p-lg-8">
              ...
              <img src="{{asset('assets/img/front-pages/landing-page/let’s-contact.png')}}" alt="let’s contact" class="w-100 mb-4 pb-1" />
