...
<div class="row">
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-4 col-sm-12 pe-md-0 mb-md-0 mb-2">
            <input class="form-control form-control-sm" id="clipboard-example" type="text" value="Copy Me!" />
          </div>
  ...
  <div class="col-12">
    <div class="card mb-6">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6 col-12 mb-md-0 mb-6">
            <p>
              Document
            ...
            <div class="btn-group mb-4">
              <button type="button" id="document-Pause" class="btn btn-primary btn-sm">
                ...
                <i class="ri-pause-fill d-sm-none"></i>
              </button>
