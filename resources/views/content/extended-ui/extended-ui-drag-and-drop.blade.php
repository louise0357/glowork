...
<div class="row mb-6" id="sortable-cards">
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card drag-item cursor-move mb-lg-0 mb-6">
      <div class="card-body text-center">
        <h2>
          <i class="ri-shopping-cart-2-line ri-24px text-success"></i>
        </h2>
        <h4>Monthly Sales</h4>
        <h5>2362</h5>
      </div>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card drag-item cursor-move mb-lg-0 mb-6">
      <div class="card-body text-center">
        <h2>
          <i class="ri-global-line ri-24px text-info"></i>
        </h2>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card drag-item cursor-move mb-lg-0 mb-6">
      <div class="card-body text-center">
        <h2>
          <i class="ri-gift-2-line ri-24px text-danger"></i>
        </h2>
        <h4>Products</h4>
        <h5>985</h5>
      </div>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card drag-item cursor-move mb-lg-0 mb-6">
      <div class="card-body text-center">
        <h2>
          <i class="ri-user-line ri-24px text-primary"></i>
        </h2>
        <h4>Users</h4>
        <h5>105,652</h5>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="d-flex flex-wrap mb-3 gap-2" id="image-list-1">
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/1.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/2.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/3.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/4.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/5.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/6.png')}}" alt="avatar" height="48" width="48" />
        </div>
        <div class="d-flex flex-wrap gap-2" id="image-list-2">
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/7.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/8.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/9.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/10.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/11.png')}}" alt="avatar" height="48" width="48" />
          <img class="rounded-circle drag-item cursor-move" src="{{asset('assets/img/avatars/12.png')}}" alt="avatar" height="48" width="48" />
        </div>
      </div>
    </div>
  </div>
