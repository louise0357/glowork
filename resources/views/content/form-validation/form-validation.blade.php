        ...
        <form class="browser-default-validation">
          ...
          <div class="mb-6 form-password-toggle">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer" id="basic-default-password3"><i class="ri-eye-off-line ri-20px"></i></span>
            </div>
          </div>
          <div class="form-floating form-floating-outline mb-6">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="mb-6 form-password-toggle">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text rounded-end cursor-pointer" id="basic-default-password4"><i class="ri-eye-off-line ri-20px"></i></span>
              <div class="valid-feedback"> Looks good! </div>
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form id="formValidationExamples" class="row g-4">
          <!-- Account Details -->
          <div class="col-12">
          ...
          <div class="col-md-6">
            <div class="form-floating form-floating-outline">
              <input type="date" class="form-control flatpickr-validation" name="formValidationDob" id="formValidationDob" placeholder="YYYY-MM-DD" required />
              ...
              <div class="form-check custom-option custom-option-icon">
                <label class="form-check-label custom-option-content" for="basicPlanMain3">
                  <span class="custom-option-body">
                    ...
                    <span class="custom-option-title mb-2"> Premium </span>
