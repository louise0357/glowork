    ...
    <div class="modal-content">
      <div class="modal-body p-0">
        ...
        <div class="col-12 text-end">
          ...
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"><span class="align-middle">submit</span><i class="ri-check-line ms-1"></i></button>
        </div>
      </div>
    </div>
  </div>
