          ...
          <div class="bs-stepper-content p-1">
            <form onSubmit="return false">
              ...
              <div id="details" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md bg-label-info d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-bar-chart-box-line ri-30px"></i></div>
                  ...
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md bg-label-success d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-shopping-cart-line ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-center">
                    <div class="avatar avatar-md bg-label-danger d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-video-upload-line ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
              ...
              <div id="frameworks" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md bg-label-info d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-reactjs-line ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md bg-label-danger d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-angularjs-fill ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md bg-label-warning d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-html5-line ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="avatar avatar-md bg-label-success d-flex align-items-center justify-content-center flex-shrink-0 me-4 rounded"><i class="ri-vuejs-fill ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
              ...
              <div id="database" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md d-flex align-items-center justify-content-center flex-shrink-0 bg-label-danger me-4 rounded"><i class="ri-fire-fill ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-center mb-4">
                    <div class="avatar avatar-md d-flex align-items-center justify-content-center flex-shrink-0 bg-label-warning me-4 rounded"><i class="ri-amazon-line ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="avatar avatar-md d-flex align-items-center justify-content-center flex-shrink-0 bg-label-info me-4 rounded"><i class="ri-database-2-fill ri-30px"></i></div>
                    <div class="d-flex justify-content-between w-100">
                      <div class="me-2">
                ...
                <div id="AppNewCCForm" class="row g-5 pt-4 pt-lg-6 mb-6" onsubmit="return false">
                  ...
                  <div class="col-6 col-md-3">
                    <div class="input-group input-group-merge">
                      ...
                      <span class="input-group-text cursor-pointer" id="modalAppAddCardCvv2"><i class="ri-question-line" data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
                    </div>
                  </div>
                  <div class="col-12">
              ...
              <div id="submit" class="content text-center pt-4 pt-lg-0">
                ...
                <!-- image -->
                <img src="{{asset('assets/img/illustrations/illustration-john.png')}}" alt="Create App img" width="265" class="img-fluid">
                <div class="col-12 d-flex justify-content-between mt-4 pt-2">
                  ...
                  <button class="btn btn-success btn-submit me-2"><span class="align-middle d-none d-sm-block">Submit</span><i class="ri-check-line"></i></button>
                </div>
              </div>
            </form>
          </div>
