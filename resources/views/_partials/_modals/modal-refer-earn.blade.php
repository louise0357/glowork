        ...
        <form class="row g-4" onsubmit="return false">
          ...
          <div class="col-lg-3 d-flex align-items-end">
            <div class="btn-social">
              <button type="button" class="btn btn-icon btn-facebook me-1"><i class="tf-icons ri-facebook-circle-line ri-22px"></i></button>
              <button type="button" class="btn btn-icon btn-twitter me-1"><i class="tf-icons ri-twitter-line ri-22px"></i></button>
