    ...
    <div class="modal-content">
      ...
      <div class="mb-6">
        <div class="form-floating form-floating-outline">
          <select id="select2Basic" class="select2 form-select share-project-select" data-allow-clear="true">
      ...
      <div class="d-flex align-items-center mt-4">
        <i class="ri-group-line ri-20px text-heading me-2 align-self-start align-self-md-center"></i>
        <div class="d-flex justify-content-between flex-grow-1 align-items-center flex-wrap gap-3">
          ...
          <button class="btn btn-outline-primary"><i class='ri-link-m me-1_5'></i>Copy Project Link</button>
        </div>
      </div>
    </div>
  </div>
