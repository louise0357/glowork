        ...
        <div class="row">
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-muted mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Google</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn text-muted p-0 shadow-none btn-pinned" aria-label="Close"><i class="ri-close-line ri-18px"></i></button>
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-muted mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Apple</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                        <div class="read-only-ratings mb-2 px-0" data-rateyo-read-only="true"></div>
                        <input type="number" class="form-control form-control-sm w-px-100" value="1" min="1" max="5">
                      </div>
                      <div class="col-md-4">
            ...
            <div class="list-group">
              <a href="javascript:void(0)" class="list-group-item text-primary d-flex justify-content-between">
      ...
      <div id="checkout-address" class="content">
        <div class="row">
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
            ...
            <button type="button" class="btn btn-outline-primary mb-6" data-bs-toggle="modal" data-bs-target="#addNewAddress">Add new address</button>
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
            ...
            <div class="col-xxl-7 col-lg-8">
              <div class="nav-align-top">
                <ul class="nav nav-pills mb-6" id="paymentTabs" role="tablist">
                  ...
                  <div class="row g-6">
                    ...
                    <div class="col-12">
                      <div class="form-check form-switch">
                        ...
                        <label for="cardFutureBilling">Save card for future billing?</label>
                      </div>
                    </div>
                    <div class="col-12">
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      <div class="col-md-8 pt-2">
                        ...
                        <div class="text-muted mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Google</a></div>
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      <div class="col-md-8 pt-2">
                        ...
                        <div class="text-muted mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Apple</a></div>
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
